...
const routes: Routes = [
  ...
  {
    path: 'frequence-respiratoire',component: FrequenceCardiaqueComponent
  },
  {
    path: 'frequence-cardiaque',component: FrequenceCardiaqueComponent
  },
  ...
  {
    path: 'profil-enfant',component: ProfilEnfantComponent
  },
  {
    path: '',
